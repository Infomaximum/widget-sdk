...
/**
 * Извлекает TypeScript-тип значения для конкретной версии версионированной схемы.
 *
 * @example
 * // Получить тип WidgetDimensionSchema версии "17"
 * type TDimV17 = TSchemaTypeForVersion<typeof WidgetDimensionSchema, "17">;
 */
export type TSchemaTypeForVersion<TSchema extends TVersionedSchema, TVersion extends string> =
